...
class _MapSelectScreenState extends State<MapSelectScreen>
  ...
  Widget _bottomBar() {
    final sel = MapCatalog.all.firstWhere((m) => m.id == _selectedId,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      sel.primaryColor,
                      sel.secondaryColor.withOpacity(0.6)
                    ],
                  ),
                  border: Border.all(
                      color: AppColors.amber.withOpacity(0.7), width: 2),
                ),
                child: Center(
                    child:
              ...
              Expanded(
                child: Column(
                    ...
                    children: [
                      ...
                      Text(
                          '${sel.animalsCount} ANIMALES · ${sel.itemsCount} ÍTEMS',
                          style: TextStyle(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            if (isSelected)
              BoxShadow(
                  color: AppColors.amber.withOpacity(0.45), blurRadius: 22),
            BoxShadow(
