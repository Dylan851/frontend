...
class _CharacterSelectScreenState extends State<CharacterSelectScreen>
  ...
  void initState() {
    super.initState();
    final prevIdx = CharacterCatalog.all.indexWhere(
        (c) => c.id == _gs.selectedCharacter && !_isEffectivelyLocked(c));
    ...
    _float = Tween<double>(begin: -3, end: 5)
  ...
  Future<void> _purchaseCurrent() async {
    ...
    try {
      ...
      // Compra cancelada por el usuario: no mostrar aviso.
    } catch (e) {
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
        ...
        return Transform.scale(
          ...
          child: Transform.translate(
            ...
            child: GestureDetector(
              ...
              child: Container(
                margin:
                    EdgeInsets.symmetric(horizontal: 10 * s, vertical: 4 * s),
                decoration: BoxDecoration(
      ...
      child: Center(
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: GameTone.goldBright.withOpacity(0.55), width: 1.4),
          ),
          child: Center(
  ...
  Widget _roleChip(String role, bool locked, double s) => Container(
        ...
        child: Text(
          ...
          style: TextStyle(
            ...
            shadows: const [
              Shadow(
                  color: Color(0xFF1A0E04), offset: Offset(0, 1), blurRadius: 0)
            ],
          ),
        ),
      );
  ...
  Widget _statRow(
          String icon, String label, double value, Color accent, double s) =>
      Row(children: [
            ...
            child: Stack(children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(4),
                  border: Border.all(
                      color: GameTone.goldTrim.withOpacity(0.35), width: 0.8),
                ),
              ),
  ...
  Widget _premiumPanel(CharacterInfo info, double s) => Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
              color: GameTone.goldBright.withOpacity(0.85), width: 1.4),
          boxShadow: [
            BoxShadow(
                color: GameTone.goldTrim.withOpacity(0.35), blurRadius: 12),
          ],
        ),
  ...
  Widget _lockedPanel(double s) => Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(10),
          border:
              Border.all(color: GameTone.goldTrim.withOpacity(0.35), width: 1),
        ),
        child: Column(children: [
  ...
  Widget _selectedBadge(double s) => Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
                color: const Color(0xFF6BE095).withOpacity(0.6),
                blurRadius: 12),
            BoxShadow(
        ...
        children: List.generate(CharacterCatalog.all.length, (i) {
          ...
          return AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: GameTone.goldTrim.withOpacity(active ? 0.9 : 0.3),
                  width: 1),
              boxShadow: active
                  ? [
                      BoxShadow(
      ...
      return GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                  color: GameTone.goldTrim.withOpacity(0.55), blurRadius: 18),
            ],
          ),
          child: Center(
            child: _purchasing
                ? const SizedBox(
                    ...
                    child: CircularProgressIndicator(
                        strokeWidth: 3, color: Color(0xFF1A0E04)),
                  )
                : Row(
                    mainAxisAlignment: MainAxisAlignment.center,
      ...
      child: AnimatedBuilder(
        ...
        builder: (_, __) => Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: const Color(0xFF6BE095)
                    .withOpacity(0.30 + 0.25 * _glow.value),
                blurRadius: 22,
                spreadRadius: 1,
              ),
            ],
