...
abstract class MapCatalog {
  static const all = <MapWorld>[
    MapWorld(
      id: 'jungle', name: 'Selva Amazónica', emoji: '🌲',
      description: 'Densa selva tropical llena de vida y misterio.',
      animalsCount: 6, itemsCount: 8, requiredLevel: 0,
      primaryColor: Color(0xFF1A4A2E), secondaryColor: Color(0xFF2D7A3A),
      isUnlocked: true,
    ),
    MapWorld(
      id: 'savanna', name: 'Sabana Africana', emoji: '🦁',
      description: 'Vastas llanuras doradas con grandes herbívoros.',
      animalsCount: 8, itemsCount: 10, requiredLevel: 5,
      primaryColor: Color(0xFF8B6914), secondaryColor: Color(0xFFC4953A),
    ),
    MapWorld(
      id: 'farm', name: 'Granja Rural', emoji: '🐄',
      description: 'Tranquila granja con animales domésticos.',
      animalsCount: 7, itemsCount: 9, requiredLevel: 10,
      primaryColor: Color(0xFF5C7A2E), secondaryColor: Color(0xFF8BB53A),
    ),
    MapWorld(
      id: 'ocean', name: 'Fondo Oceánico', emoji: '🐬',
      description: 'Profundidades marinas llenas de criaturas asombrosas.',
      animalsCount: 9, itemsCount: 12, requiredLevel: 15,
      primaryColor: Color(0xFF0D4A7A), secondaryColor: Color(0xFF1A7FC4),
    ),
    MapWorld(
      id: 'arctic', name: 'Ártico Polar', emoji: '🐧',
      description: 'Heladas tierras polares con fauna polar única.',
      animalsCount: 6, itemsCount: 7, requiredLevel: 20,
      primaryColor: Color(0xFF2A4A6A), secondaryColor: Color(0xFF4A7AAA),
    ),
    MapWorld(
      id: 'desert', name: 'Desierto Sahara', emoji: '🐪',
      description: 'Áridas dunas con animales perfectamente adaptados.',
      animalsCount: 7, itemsCount: 8, requiredLevel: 25,
      primaryColor: Color(0xFF7A4A1A), secondaryColor: Color(0xFFC48A3A),
    ),
    MapWorld(
      id: 'volcano', name: 'Isla Volcánica', emoji: '🦎',
      description: 'Isla de lava y reptiles prehistóricos.',
      animalsCount: 5, itemsCount: 6, requiredLevel: 30,
      primaryColor: Color(0xFF4A0D0D), secondaryColor: Color(0xFF8B1A1A),
    ),
    MapWorld(
      id: 'sky', name: 'Cielos Nublados', emoji: '🦅',
      description: 'Altísimas cimas con aves majestuosas.',
      animalsCount: 6, itemsCount: 7, requiredLevel: 40,
