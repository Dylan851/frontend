...
// Datos de los 6 animales del juego, sus hechos curiosos y tipo de minijuego
...
/// Catálogo completo de animales del juego
class AnimalCatalog {
  static const List<AnimalData> all = [
    AnimalData(
      ...
      habitat: 'Bosque',
      description:
          'El zorro rojo es uno de los animales más inteligentes del bosque. '
    ...
    AnimalData(
      ...
      name: 'Ciervo',
      emoji: '🦌',
      habitat: 'Pradera y Bosque',
      description:
          'El ciervo es un elegante habitante del bosque. Solo los machos '
    ...
    AnimalData(
      ...
      name: 'Búho Real',
      emoji: '🦉',
      habitat: 'Bosque nocturno',
      description:
          'El búho real es el mayor búho de Europa. Caza de noche gracias a '
    ...
    AnimalData(
      ...
      description:
          'La mariposa monarca realiza una de las migraciones más increíbles '
      ...
      diet: 'Néctar de flores',
      size: '10 cm de envergadura',
    ),
    ...
    AnimalData(
      ...
      description:
          'El oso pardo es el mayor carnívoro terrestre de Europa. Pasa el '
    ...
    AnimalData(
      ...
      description:
          'La rana venenosa es famosa por sus colores brillantes que advierten '
